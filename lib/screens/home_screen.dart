...
class _HomeScreenState extends State<HomeScreen> {
  ...
  var _languages = {"English": "en", "French": "fr", "Spanish": "es", "Arabic": "ar",
                    "Urdu" : "ur", "Italian": "it", "Russian" : "ru", "German" : "de", "Dutch" : "nl"};
  ...
  void _onDropDownItemSelected(String newValueSelected) async {
    ...
    var translation = await googleTranslator.translate(text, to: _languages[newValueSelected]);
    setState(() {
  ...
  List<dynamic> genImages(String text) {
    ...
    for(var c in text.runes) {
      result.add(Image(image: NetworkImage((_signImages ?? const {})[String.fromCharCode(c).toLowerCase()] ??
